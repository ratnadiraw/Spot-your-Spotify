...
<div class="ui fullscreen modal test">
    ...
    <div class="image content" style="padding-left: 3px">
                ...
                <div class="stretched row">
                    <div class="column" style="width: 370px; padding-left: 0">
                        ...
                        <div class="ui segment" style="height: 360px; margin-top:30px";>
                            <div class="ui icon" data-title="Using click events" data-content="Clicked popups will close if you click away, but not if you click inside the popup" style="margin-bottom: 0; text-align: right">
                                what is this shit?
                            </div>
